...
file_path = "/data3/embodied/libero_hdf5_w_feats/libero_goal/open_the_middle_drawer_of_the_cabinet_demo.hdf5"
with h5py.File(file_path, 'r') as f:
    ...
    image_data = agentview_rgb[random_index][::-1, ::-1]
    wrist_data = wrist_rgb[random_index][::-1, ::-1] 
