...
class AlohaPutTheLeftCubeIntoThePlateDataset(tfds.core.GeneratorBasedBuilder):
    """DatasetBuilder for example dataset."""

    NAME = 'aloha_put_the_left_cube_into_the_plate'
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob("/data1/ALOHA/processed/put_the_left_cube_into_the_plate/train/episode_*.hdf5"),
        }
