...
class AlohaPutTheToyToTheRightOfTheCupDataset(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob("/data3/embodied/galaxea/r1lite/processed/put_the_toy_to_the_right_of_the_cup/train/episode_*.hdf5"),
        }
