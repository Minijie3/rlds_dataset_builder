...
class AlohaTwoTaskFuseDataset(tfds.core.GeneratorBasedBuilder):
    """DatasetBuilder for example dataset."""

    NAME = 'aloha_put_the_toy_to_the_right_of_the_cup'
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob("/data3/embodied/galaxea/r1lite/processed/put_the_duck_to_the_right_of_the_cup/train/episode_*.hdf5") + glob.glob("/data3/embodied/galaxea/r1lite/processed/swap_red_duck_and_blue_duck/train/episode_*.hdf5"),
        }
