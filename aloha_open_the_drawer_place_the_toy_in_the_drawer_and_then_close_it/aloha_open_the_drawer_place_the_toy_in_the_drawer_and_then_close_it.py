...
class AlohaOpenTheDrawerPlaceTheToyInTheDrawerAndThenCloseItDataset(tfds.core.GeneratorBasedBuilder):
    """DatasetBuilder for example dataset."""

    NAME = 'aloha_open_the_drawer_place_the_toy_in_the_drawer_and_then_close_it'
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob("/data3/embodied/galaxea/processed/open_the_drawer_place_the_toy_in_the_drawer_and_then_close_it/train/episode_*.hdf5")
        }
