...
class AlohaFoldTheTowelDataset(tfds.core.GeneratorBasedBuilder):
    """DatasetBuilder for example dataset."""

    NAME = 'aloha_fold_the_towel'
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob("/data3/embodied/galaxea/processed/fold_the_towel/train/episode_*.hdf5")
        }
