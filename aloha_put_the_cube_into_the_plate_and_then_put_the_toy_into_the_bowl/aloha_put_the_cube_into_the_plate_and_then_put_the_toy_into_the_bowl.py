...
class AlohaPutTheCubeIntoThePlateAndThenPutTheToyIntoTheBowlDataset(tfds.core.GeneratorBasedBuilder):
    """DatasetBuilder for example dataset."""

    NAME = 'aloha_put_the_cube_into_the_plate_and_then_put_the_toy_into_the_bowl'
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob("/data1/ALOHA/processed/put_the_cube_into_the_plate_and_then_put_the_toy_into_the_bowl/train/episode_*.hdf5")
        }
