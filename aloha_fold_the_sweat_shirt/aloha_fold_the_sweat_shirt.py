...
class AlohaFoldTheSweatShirtDataset(tfds.core.GeneratorBasedBuilder):
    """DatasetBuilder for example dataset."""

    NAME = 'aloha_fold_the_sweat_shirt'
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob("/data3/embodied/galaxea/processed/fold_the_sweatshirt/train/episode_*.hdf5")
        }
